...
export const storySeries: StorySeries[] = [{
 ...
 seoTitle:"Other Alice Adventures | A Living Illustrated Wonderland", metaDescription:"A web-native surreal fantasy serial and illustrated world archive about the Alice who chose to stay, and the living country that continued around her.",
 eyebrow:"HobFarm Presents", tagline:"A web-native surreal fantasy serial and illustrated world archive.",
 ...
 description:["Other Alice Adventures unfolds across the website as an illustrated serial and world archive. Its stories, maps, diagrams, characters, creatures, artifacts, and records share one connected Wonderland.","Alice lives inside this country rather than passing through its famous scenes. She studies local conditions, prepares remedies, investigates routes, and works with people whose systems follow their own rules."],
