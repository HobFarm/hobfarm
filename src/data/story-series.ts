...
export const storySeries: StorySeries[] = [{
 ...
 seoTitle:"Other Alice Adventures | A Persistent Interactive Wonderland", metaDescription:"A persistent story game set in an authored Wonderland where choices, relationships, time, and consequences build the long-form account of each campaign.",
 eyebrow:"HobFarm Presents", tagline:"A persistent interactive story set inside an authored, illustrated Wonderland.",
 ...
 heroIntro:["The familiar story is the doorway. The project follows the settlements, economies, ecologies, institutions, species, infrastructure, histories, and borders beyond its famous scenes.","The public guide records the shared world. Wonder Machine turns its authored places, characters, conditions, and consequences into persistent campaigns."],
 ...
 description:["Other Alice Adventures is a persistent story game and public world archive. Maps, diagrams, characters, creatures, artifacts, and records describe one authored Wonderland; each campaign creates a different history inside it.","Alice lives inside this country rather than passing through its famous scenes. She studies local conditions, prepares remedies, investigates routes, and works with people whose systems follow their own rules."],
