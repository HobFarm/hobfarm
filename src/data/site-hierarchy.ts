...
export const presentsSeries: HierarchyEntry[] = [
  ...
  { id: "other-alice", slug: "other-alice-adventures", name: "Other Alice Adventures", shortName: "Other Alice", description: "An illustrated serial where wet, living Wonderland collides with the dry geometry of Wasteland.", href: "/presents/other-alice-adventures/", parent: "presents", kind: "presents-series", status: "active", heroImage: hero("other-alice-hero.png"), heroAlt: "Wonderland's liquid growth meeting the crystalline Wasteland", theme: "alice", order: 1, ctaLabel: "Cross the boundary" },
