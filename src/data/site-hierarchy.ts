...
export const workshopPrograms: HierarchyEntry[] = [
  ...
  { id: "before-after", slug: "before-and-after", name: "Before & After", description: "Documentary comparisons, restorations, alternate histories, and character changes built around one recognizable subject.", href: "/workshop/before-and-after/", parent: "workshop", kind: "workshop-program", status: "active", heroImage: getMedia("before-after.shit-to-shine.after").src, heroAlt: getMedia("before-after.shit-to-shine.after").alt, theme: "comparison", order: 4, ctaLabel: "Compare the work", featuredQuery: { galleryType: "before-and-after" } },
  { id: "workshop-notes", slug: "workshop-notes", name: "Workshop Notes", description: "Readable process logs covering methods, tests, revisions, failures, tool choices, and build records.", href: "/workshop/workshop-notes/", parent: "workshop", kind: "workshop-program", status: "active", heroImage: getMedia("workshop.graphics.landing").src, heroAlt: getMedia("workshop.graphics.landing").alt, theme: "notes", order: 5, ctaLabel: "Read the notes", featuredQuery: { department: "workshop-notes" } },
  { id: "stylefusion", slug: "stylefusion", name: "StyleFusion", description: "A separate reference-image application that assigns approved images to roles, runs specialized extraction agents, compiles an Intermediate Representation, and exports a model-ready generation document.", href: "/workshop/stylefusion/", parent: "workshop", inNav: false, noindex: true, kind: "workshop-program", status: "active", heroImage: getMedia("stylefusion.banner.image").src, heroAlt: getMedia("stylefusion.banner.image").alt, theme: "stylefusion", order: 6, ctaLabel: "Inspect the application", featuredQuery: { department: "workshop-notes", series: "StyleFusion" } },
];
