...
export const siteSections: HierarchyEntry[] = [
  ...
  { id: "presents", slug: "hobfarm-presents", name: "HobFarm Presents", shortName: "Presents", description: "The imprint for recurring stories, film history, cartoons, video, and named editorial worlds.", href: "/departments/hobfarm-presents/", kind: "site-section", status: "active", heroImage: hero("hobfarm-presents-hero.png"), heroAlt: "A collage of HobFarm Presents stories and series", theme: "presents", order: 2, ctaLabel: "Enter Presents", countNoun: "series" },
  { id: "workshop", slug: "workshop", name: "Workshop", description: "The machinery beneath the magazine: experiments, methods, revisions, character systems, production notes, and finished tests.", href: "/workshop/", kind: "site-section", status: "active", heroImage: hero("workshop-hero.png"), heroAlt: "HobFarm Workshop production collage", theme: "workshop", order: 3, ctaLabel: "Open the Workshop", countNoun: "programs" },
  ...
  { id: "shop", slug: "shop", name: "Shop", description: "Finished assets, packs, posters, character sheets, downloads, commissions, and physical work.", href: "/shop/", kind: "site-section", status: "active", theme: "editorial", order: 5, ctaLabel: "Browse the Shop" },
...
export const workshopPrograms: HierarchyEntry[] = [
  { id: "before-after", slug: "before-and-after", name: "Before & After", description: "Paired transformations that keep the subject readable while era, styling, posture, setting, and production language change.", href: "/workshop/before-and-after/", parent: "workshop", kind: "workshop-program", status: "active", heroImage: hero("before-after-hero.png"), heroAlt: "A paired before-and-after transformation", theme: "comparison", order: 1, ctaLabel: "Compare the work", featuredQuery: { galleryType: "before-and-after" } },
  ...
  { id: "character-mannequin", slug: "character-mannequin", name: "Character / Mannequin", description: "Numbered character systems, model sheets, turnarounds, wardrobe variants, poses, camera tests, and continuity notes.", href: "/workshop/character-mannequin/", parent: "workshop", kind: "workshop-program", status: "active", theme: "character-sheet", order: 4, ctaLabel: "Open the model sheet" },
  { id: "stylefusion", slug: "stylefusion", name: "StyleFusion", description: "Style references translated into explicit visual ingredients, controlled blends, comparisons, and reusable systems.", href: "/workshop/stylefusion/", parent: "workshop", kind: "workshop-program", status: "active", theme: "stylefusion", order: 5, ctaLabel: "Study the blend", featuredQuery: { department: "workshop-notes", series: "StyleFusion" } },
  { id: "workshop-notes", slug: "workshop-notes", name: "Workshop Notes", description: "Readable process logs covering methods, tests, revisions, failures, tool choices, and build records.", href: "/workshop/workshop-notes/", parent: "workshop", kind: "workshop-program", status: "active", heroImage: hero("workshop-hero.png"), heroAlt: "HobFarm Workshop tools and production material", theme: "notes", order: 6, ctaLabel: "Read the notes", featuredQuery: { department: "workshop-notes" } },
];
