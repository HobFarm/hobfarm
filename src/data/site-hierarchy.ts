...
export const supportingWorkshopPrograms: readonly HierarchyEntry[] = [
  ...
  { id: "stylefusion", slug: "stylefusion", name: "StyleFusion", description: "A working reference-image application that assigns simple Subject, Style, and Composition jobs, builds a reusable modular pack, and translates it into positive generation prose.", href: "/workshop/stylefusion/", parent: "workshop", inNav: false, noindex: false, kind: "workshop-program", status: "active", heroImage: getMedia("stylefusion.current.psychedelic.hero").src, heroAlt: getMedia("stylefusion.current.psychedelic.hero").alt, theme: "stylefusion", order: 11, ctaLabel: "Open StyleFusion", featuredQuery: { department: "workshop-notes", series: "StyleFusion" } },
];
