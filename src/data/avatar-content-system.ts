...
export const avatarCourse = {
  ...
  purchasePath: "/academy/courses/avatar-content-system/#access",
  loginPath: "/login?next=/academy/avatar-content-system/course",
  accessModel: "permanent-or-membership" as const,
  priceLabel: "$5/month",
  permanentPriceLabel: "$7 one time",
  freeLessonCount: 4,
  paidLessonCount: 12,
  betaCta:
    "The four setup lessons are public. The 12 paid lessons are $7 for permanent account access or included while the $5/month HobFarm membership is active.",
  standaloneNote: "The permanent-purchase path is built but remains off until the production price, tax, refund, and webhook checks are complete.",
