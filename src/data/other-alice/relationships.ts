...
export const relationshipNodes: RelationshipNode[] = [
  ...
  { id: "other-alice", label: "Other Alice", kind: "person", x: 48, y: 50, summary: "Resident field observer and boundary-tester" },
  { id: "chester", label: "Chester", kind: "person", x: 37, y: 51, summary: "Independent diagnostic guide" },
  ...
  { id: "white-rabbit", label: "White Rabbit", kind: "person", x: 57, y: 64, summary: "Individual route-facing clockkeeper" },
...
export const relationshipEdges: RelationshipEdge[] = [
  ...
  { id: "alice-chester", source: "other-alice", target: "chester", kind: "knowledge", label: "trusts the route refusals of", evidence: "Continuous field notes and repeated threshold observations", certainty: "confirmed" },
