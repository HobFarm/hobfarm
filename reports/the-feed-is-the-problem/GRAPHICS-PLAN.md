# The Feed Is the Problem: graphics plan

| Graphic | Job | Placement | Accessibility |
| --- | --- | --- | --- |
...
The visual treatment uses the existing HobFarm dark palette, orange system paths, cyan reader-controlled paths, restrained borders, and no animation. The body figures collapse cleanly at narrow widths and remain understandable without color or image loading.
