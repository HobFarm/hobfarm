...
const requiredFiles = [
  ...
  "src/pages/departments/hobfarm-presents/index.md.ts",
  "src/pages/departments/hobfarm-presents/llms.txt.ts",
  "src/pages/departments/hobfarm-presents/[series]/index.md.ts",
  "src/pages/departments/hobfarm-presents/[series]/[slug]/index.md.ts",
...
test("agent-readable corpus routes and markdown alternates are wired", () => {
  ...
  for (const route of [
    ...
    "https://hob.farm/departments/hobfarm-presents/",
    "https://hob.farm/departments/hobfarm-presents/other-alice-adventures/",
